...
Recall "Aesthetics" (lecture on data visualization):

>>> aesthetic < Greek aisthētikos < aisthēta ‘perceptible things’ < aisthesthai ‘perceive’ 
...
In modern usage (since mid 18th c., first in German and then in Engish), aesthetics can also mean taste or beauty. 
